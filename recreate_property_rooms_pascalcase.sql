-- recreate_property_rooms_pascalcase.sql
-- Drop and recreate property_rooms table with PascalCase column names

-- Drop the existing table (this will delete all data!)
DROP TABLE IF EXISTS property_rooms CASCADE;

-- Create the new property_rooms table with PascalCase column names
...
COMMENT ON TABLE property_rooms IS 'Property room details with PascalCase field names';
