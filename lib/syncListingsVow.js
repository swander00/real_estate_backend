...
// Table configuration for VOW - MEDIA REMOVED
const TABLES = [
  {
    name: 'common_fields',
  ...
  },
  {
    ...
    url: process.env.VOW_URL + "&$filter=PropertyType eq 'Residential Freehold'",
    token: process.env.VOW_TOKEN,
  ...
  },
  {
    ...
    url: process.env.VOW_URL + "&$filter=PropertyType ne 'Residential Freehold' and TransactionType ne 'For Lease'",
    token: process.env.VOW_TOKEN,
  ...
  },
  {
    ...
    url: process.env.VOW_URL + "&$filter=TransactionType eq 'For Lease'",
    token: process.env.VOW_TOKEN,
