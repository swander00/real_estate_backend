...
import { fetchODataPage } from './fetchFeed.js';  // ← Changed: same folder
...
const TABLES = [
  ...
  },
  {
    ...
    conflictKeys: 'OpenHouseKey', // CORRECTED: Use OpenHouseKey as primary key
    filterFn: (r) => !!r.ListingKey && !!r.OpenHouseKey, // CORRECTED: Check both
    enforceParent: false,
    priority: 3
  },
  {
    ...
    conflictKeys: 'MediaKey', // CORRECTED: Use MediaKey as primary key
    filterFn: (r) => !!r.ResourceRecordKey && !!r.MediaKey, // CORRECTED: Check both
    enforceParent: true,
    priority: 3
  },
  {
    ...
    conflictKeys: 'RoomKey', // CORRECTED: Use RoomKey as primary key
    filterFn: (r) => !!r.RoomKey && !!r.ListingKey, // CORRECTED: Check both
    enforceParent: true,
    priority: 3
  }
];
