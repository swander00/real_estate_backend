...
export function mapPropertyMedia(item) {
  return {
    ...
    // === DISPLAY & ORDERING ===
    Order: item.Order ? parseInt(item.Order) : null,             // Display order
    PreferredPhotoYN: item.PreferredPhotoYN === true || 
                      item.PreferredPhotoYN === 'true' || 
                      item.PreferredPhotoYN === 'Yes',           // Is this the preferred/primary photo
